...
#define SELECT_LPMS_CAN_BAUDRATE_125K           0
#define SELECT_LPMS_CAN_BAUDRATE_250K           1
#define SELECT_LPMS_CAN_BAUDRATE_500K           2
#define SELECT_LPMS_CAN_BAUDRATE_1M             3
...
#define SELECT_LPMS_UART_BAUDRATE_38400         1
#define SELECT_LPMS_UART_BAUDRATE_57600         2
#define SELECT_LPMS_UART_BAUDRATE_115200        3
#define SELECT_LPMS_UART_BAUDRATE_230400        4
#define SELECT_LPMS_UART_BAUDRATE_256000        5
#define SELECT_LPMS_UART_BAUDRATE_460800        6
#define SELECT_LPMS_UART_BAUDRATE_921600        7
